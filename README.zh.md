...
[![](https://img.shields.io/github/v/release/mr-bz/3x-ui.svg)](https://github.com/mr-bz/3x-ui/releases)
[![](https://img.shields.io/github/actions/workflow/status/mr-bz/3x-ui/release.yml.svg)](#)
[![GO Version](https://img.shields.io/github/go-mod/go-version/mr-bz/3x-ui.svg)](#)
[![Downloads](https://img.shields.io/github/downloads/mr-bz/3x-ui/total.svg)](#)
...
<p align="left"><a href="#"><img width="125" src="https://github.com/mr-bz/3x-ui/assets/115543613/7aa895dd-048a-42e7-989b-afd41a74e2e1" alt="Image"></a></p>
...
```
bash <(curl -Ls https://raw.githubusercontent.com/mr-bz/3x-ui/master/install.sh)
```
...
```
bash <(curl -Ls https://raw.githubusercontent.com/mr-bz/3x-ui/master/install.sh) v2.3.4
```
...
wget https://github.com/mr-bz/3x-ui/releases/latest/download/x-ui-linux-${XUI_ARCH}.tar.gz
```
...
2. 克隆仓库：
   ...
   ```sh
   git clone https://github.com/mr-bz/3x-ui.git
   cd 3x-ui
   ```
...
[![Stargazers over time](https://starchart.cc/mr-bz/3x-ui.svg)](https://starchart.cc/mr-bz/3x-ui)
